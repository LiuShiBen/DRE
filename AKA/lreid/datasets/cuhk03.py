...
from lreid.utils import read_json, write_json, mkdir_if_missing
...
class IncrementalSamples4cuhk03(IncrementalPersonReIDSamples):
    ...
    '''
    dataset_dir = 'CUHK03'
    def __init__(self, datasets_root, relabel=True, combineall=False, split_id=0, cuhk03_labeled=False,
