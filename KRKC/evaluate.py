...
def main_worker(args):
    ...
    dataset_dukemtmc, num_classes_dukemtmc, train_loader_dukemtmc, test_loader_dukemtmc, init_loader_dukemtmc = \
        get_data('dukemtmc', args.data_dir, args.height, args.width, args.batch_size, args.workers,
                 args.num_instances)

    dataset_cuhksysu, num_classes_cuhksysu, train_loader_cuhksysu, test_loader_cuhksysu, init_loader_chuksysu = \
        get_data('cuhk_sysu', args.data_dir, args.height, args.width, args.batch_size, args.workers,
                 args.num_instances)

    dataset_msmt17, num_classes_msmt17, train_loader_msmt17, test_loader_msmt17, init_loader_msmt17 = \
        get_data('msmt17', args.data_dir, args.height, args.width, args.batch_size, args.workers,
                 args.num_instances)

    dataset_cuhk03, num_classes_cuhk03, _, test_loader_cuhk03, _ = \
        get_data('CUHK03', args.data_dir, args.height, args.width, args.batch_size, args.workers,
                 args.num_instances)

    dataset_cuhk02, num_classes_cuhk02, _, test_loader_cuhk02, _ = \
        get_data('CUHK02', args.data_dir, args.height, args.width, args.batch_size, args.workers,
                 args.num_instances)

    dataset_prid, num_classes_prid, train_loader_prid, test_loader_prid, init_loader_prid = \
        get_data('prid2011', args.data_dir, args.height, args.width, args.batch_size, args.workers,
                 args.num_instances)
    ...
    test_loaders = [test_loader_viper, test_loader_Grid, test_loader_cuhk03, test_loader_cuhk02, test_loader_Duke,
                    test_loader_Reid, test_loader_prid, test_loader_market, test_loader_dukemtmc, test_loader_cuhksysu,
                    test_loader_msmt17]'''
...
if __name__ == '__main__':
    ...
    # training configs
    parser.add_argument('--resume_working', type=str, default='./order2_logs/working_checkpoint_step_4.pth.tar', metavar='PATH')
    parser.add_argument('--resume_memory', type=str, default='./order2_logs/working_checkpoint_step_4.pth.tar', metavar='PATH')
    ...
    parser.add_argument('--logs_dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'order2_logs'))
