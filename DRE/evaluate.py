...
def main_worker(args):
    ...
    model = build_vit_backbone(num_class=num_classes_total)
    model.cuda()
...
if __name__ == '__main__':
    ...
    # training configs
    parser.add_argument('--resume_working', type=str, default='./Order-1/current_checkpoint_step_5.pth.tar',
                        metavar='PATH')
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.joincurrent_dir, 'order1'))
